...
public class GoldSubscription implements PassengerSubscription {
    ...
    public GoldSubscription(Activity activity, Passenger passenger) {
    ...
    private double calculateSubscriptionCharge(){
        return this.activity.getCost() * 0.9;
    }
